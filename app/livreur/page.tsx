...
export default function LivreurPage() {
  ...
  // Données simulées pour l'espace livreur
        ...
        <div className="container mx-auto px-4 max-w-md">
          <Card className="dark:bg-neutral-800 dark:border-neutral-700">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-[#0D1B2A] dark:text-neutral-100">Espace Livreur</CardTitle>
              <p className="text-gray-600 dark:text-neutral-300">Connectez-vous pour voir vos trajets</p>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-4">
                <div>
                  <Label htmlFor="id">Identifiant livreur</Label>
                  <Input
                    id="id"
                    value={loginData.id}
    ...
    <div className="min-h-screen bg-[#F4FBFD] dark:bg-neutral-900 py-8 transition-colors">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#0D1B2A] dark:text-neutral-100 mb-2">Tableau de bord livreur</h1>
            <p className="text-gray-600 dark:text-neutral-300">Bienvenue Jean Kouassi</p>
          </div>
        ...
        <Tabs defaultValue="trajets" className="space-y-6">
          ...
          <TabsContent value="trajets" className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-[#0D1B2A] dark:text-neutral-100">Trajets disponibles</h2>
              <Badge variant="secondary">{trajetsDisponibles.length} trajets</Badge>
            </div>

            {trajetsDisponibles.map((trajet) => (
              <Card className="dark:bg-neutral-800 dark:border-neutral-700" key={trajet.id}>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          <p className="text-gray-600 dark:text-neutral-300">Date & Heure</p>
          ...
          <TabsContent value="livraisons" className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold text-[#0D1B2A] dark:text-neutral-100">Mes livraisons en cours</h2>
              <Badge variant="secondary">{mesLivraisons.length} livraison(s)</Badge>
            </div>

            {mesLivraisons.map((livraison) => (
              <Card className="dark:bg-neutral-800 dark:border-neutral-700" key={livraison.code}>
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
