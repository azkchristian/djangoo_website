        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <Card className="text-center">
            <CardContent className="p-8">
              ...
              <h2 className="text-2xl font-bold text-[#0D1B2A] mb-4">Candidature envoyée avec succès !</h2>
              ...
              <div className="bg-[#1CA9C9]/10 border border-[#1CA9C9] rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-600 mb-2">Prochaines étapes</p>
    ...
    <div className="min-h-screen bg-[#F4FBFD] py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#0D1B2A] mb-4">Devenez chauffeur Djongoo</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Rejoignez notre réseau de chauffeurs partenaires et participez à la révolution de la livraison en Afrique de
            l'Ouest
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {/* Avantages */}
          <div>
            <h2 className="text-2xl font-bold text-[#0D1B2A] mb-6">Pourquoi devenir chauffeur Djongoo ?</h2>
            <div className="space-y-4">
              <Card>
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#0D1B2A] mb-2">Revenus attractifs</h3>
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#0D1B2A] mb-2">Flexibilité</h3>
                    <p className="text-gray-600 text-sm">
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#0D1B2A] mb-2">Communauté</h3>
                    <p className="text-gray-600 text-sm">
                      Rejoignez une communauté de chauffeurs professionnels avec support 24/7
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#0D1B2A] mb-2">Couverture étendue</h3>
                    <p className="text-gray-600 text-sm">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center">Processus de recrutement</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <p className="text-sm text-gray-600">Remplissez le formulaire en ligne</p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600">Vérification des documents et références</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-[#1CA9C9] rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-gray-600">Entretien téléphonique avec notre équipe</p>
              </div>
              <div>
                <div className="w-12 h-12 bg-[#158B9A] rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-gray-600">Formation et intégration dans l'équipe</p>
              </div>
            </div>
          </CardContent>
        </Card>
